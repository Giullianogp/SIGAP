...
ADOQUERY1.CLOSE;
adoquery1.SQL.clear;
adoquery1.SQL.Add('select nome as Nome, categoria as Categoria, quantidade as Quantidade, descricao as Descrição from equipamento where categoria = "'+combobox1.items[combobox1.itemindex]+'"');
adoquery1.Open;
...
begin
  messagedlg('Quantidade não pode ser menor que 0', mterror, [mbok], 0);
end
else
begin
  Datamodule3.equipamento.Edit;
